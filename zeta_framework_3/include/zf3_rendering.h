...
namespace zf3 {
    ...
    void write_to_sprite_batch(Renderer& renderer, const int layerIndex, const int texIndex, const Textures& textures, const Vec2D pos, const Rect srcRect, const Vec2D origin = {0.5f, 0.5f}, const float rot = 0.0f, const Vec2D scale = {1.0f, 1.0f}, const float alpha = 1.0f);
